...
import com.example.Jaecheon.model.shop.dao.CartDAO;
...
public class JFreeChartServiceImpl implements JFreeChartService {
	...
	public JFreeChart createChart() {
		...
		/*
		 * DefaultCategoryDataset dataset = new DefaultCategoryDataset(); for(CartDTO
		 * dto : list) { dataset.setValue(dto.getMoney(), "술", dto.getProduct_name()); }
		 */

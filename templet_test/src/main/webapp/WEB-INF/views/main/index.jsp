          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li><a href="<%=request.getContextPath()%>/page/shop.do">Shop</a></li>
                <li><a href="#">Catalogue</a></li>
                <li><a href="#">New Arrivals</a></li>
                <li><a href="<%=request.getContextPath()%>/page/contact.do">Contact</a></li>
              </ul>
            </nav>
          </div>
          <div class="icons">
            ...
            <a href="main/cart.jsp" class="icons-btn d-inline-block bag">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 order-1 align-self-end">
            <img src="${path}/images/model_3.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row align-items-stretch">
          <div class="col-lg-8">
            <div class="product-item sm-height full-height bg-gray">
              ...
              <img src="${path}/images/model_4.png" alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-4">
            <div class="product-item sm-height bg-gray mb-4">
              <a href="#" class="product-category">Men <span>25 items</span></a>
              <img src="${path}/images/model_5.png" alt="Image" class="img-fluid">
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="<%=request.getContextPath()%>/page/shopsingle.do" class="product-item md-height bg-gray d-block">
              <img src="${path}/images/prod_2.png" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="<%=request.getContextPath()%>/page/shopsingle.do">Gray Shoe</a></h2>
            <strong class="item-price">$20.00</strong>
          </div>
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="${path}/images/prod_3.png" alt="Image" class="img-fluid">
            </a>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="${path}/images/prod_1.png" alt="Image" class="img-fluid">
            </a>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="${path}/images/model_1.png" alt="Image" class="img-fluid">
            </a>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="${path}/images/model_7.png" alt="Image" class="img-fluid">
            </a>
